...
* **sessions:** add sandbox config knob and per-session UI indicator ([#240](https://github.com/pmatos/pewpew/issues/240)) ([5dbf0ba](https://github.com/pmatos/pewpew/commit/5dbf0bab568865da9f7f66f714307454600d31f5))
